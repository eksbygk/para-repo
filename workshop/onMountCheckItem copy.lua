...
ctx:fillText("特制胶水*" .. itemTable["blocktemplates/k23.bmax"]["num"], 10, positionY[1])
ctx:fillText("木工锯*" .. itemTable["blocktemplates/k22.bmax"]["num"], 10, positionY[2])
ctx:fillText("普通木板*" .. itemTable["blocktemplates/k18.bmax"]["num"], 10, positionY[3])
ctx:fillText("尺子*" .. itemTable["blocktemplates/g28.bmax"]["num"], 10, positionY[4])
ctx:fillText(itemTable["blocktemplates/k23.bmax"]["type"], 140, positionY[1])
ctx:fillText(itemTable["blocktemplates/k22.bmax"]["type"], 140, positionY[2])
ctx:fillText(itemTable["blocktemplates/k18.bmax"]["type"], 140, positionY[3])
ctx:fillText(itemTable["blocktemplates/g28.bmax"]["type"], 140, positionY[4])
-- end)
...
registerBroadcastEvent("onMountCheckItem", function(msg)
    ...
    if (itemTable[mountedFileName]["type"] == "待收集") then
        renderDialog()
        itemTable[mountedFileName]["type"] = "已完成"
        itemTable[mountedFileName]["color"] = "#00ff00"
        local index = itemTable[mountedFileName]["index"]
        ctx:clearRect()
        ctx.fillStyle = "#00000095"
        ctx:fillRect(0, 0, ctx:getWidth(), ctx:getHeight())
        ctx.font = "Microsoft YaHei;20;"
        ...
        ctx.fillStyle = itemTable["blocktemplates/k23.bmax"]["color"]
        ctx:fillText(itemTable["blocktemplates/k23.bmax"]["type"], 140, positionY[1])
        ctx.fillStyle = itemTable["blocktemplates/k22.bmax"]["color"]
        ctx:fillText(itemTable["blocktemplates/k22.bmax"]["type"], 140, positionY[2])
        ctx.fillStyle = itemTable["blocktemplates/k18.bmax"]["color"]
        ctx:fillText(itemTable["blocktemplates/k18.bmax"]["type"], 140, positionY[3])
        ctx.fillStyle = itemTable["blocktemplates/g28.bmax"]["color"]
        ctx:fillText(itemTable["blocktemplates/g28.bmax"]["type"], 140, positionY[4])
